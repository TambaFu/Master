...
if __name__ == "__main__":  # スクリプトを直接実行したときに実行されるメイン処理
    ...
    # 複数のサンプルサイズで実験
    for N in [200]:#200, 500, 1000, 2000, 5000, 10000, 20000]:
        #sampleをNこランダムで選ぶ
